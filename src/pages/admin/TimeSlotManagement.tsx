...
export default function TimeSlotManagement() {
  ...
  const slotsByActivity = timeSlots.reduce(
    (acc, slot) => {
    ...
    {} as Record<
      string,
      {
        activity: TimeSlotWithDetails['event_activity']['activity'];
        slots: TimeSlotWithDetails[];
      }
    >,
  );
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      {slots.reduce((sum, s) => sum + s.capacity, 0)} places
                      totales
                    </p>
                  </div>
                </div>
      ...
      {Object.keys(slotsByActivity).length === 0 && (
        <div className="bg-white rounded-lg shadow-sm p-12 text-center">
          ...
          <p className="text-sm text-gray-500">
            💡 Conseil : Gérez les créneaux directement depuis la configuration
            des événements
          </p>
        </div>
      )}
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <div className="min-w-max">
            ...
            <div className="flex border-b border-gray-200">
              ...
              {hours.map((hour) => (
                <div
                  ...
                  className="w-24 p-2 text-center text-sm font-medium text-gray-700 border-l border-gray-200"
                >
                  {format(hour, 'HH:mm')}
                </div>
              ))}
            ...
            {/* Lignes par activité */}
            {Object.entries(slotsByActivity).map(
              ([key, { activity, slots }]) => (
                <div key={key} className="flex border-b border-gray-200">
                  ...
                  {hours.map((hour) => {
                    ...
                    return (
                      <div
                        key={hour.toISOString()}
                        className="w-24 p-1 border-l border-gray-200"
                      >
                        {hourSlots.map((slot) => (
                          <div
                            key={slot.id}
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Vue d'ensemble et supervision des créneaux
          </p>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800 mt-1">
              Cette page offre une vue d'ensemble des créneaux. Pour créer ou
              modifier des créneaux, rendez-vous dans{' '}
              <strong>Gestion des Événements</strong> →{' '}
              <strong>Gérer les activités</strong>.
            </p>
          </div>
        </div>
      </div>
      ...
      {!selectedEvent || !selectedDate ? (
        <div className="bg-white rounded-lg shadow-sm p-12 text-center">
          ...
          <p className="text-gray-600">
            Choisissez un événement et une date pour visualiser les créneaux.
          </p>
        </div>
      ) : viewMode === 'dashboard' ? (
        renderDashboardView()
