            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              <div className="space-y-4">
                ...
                {formData.has_animations && (
                  <div className="ml-7 p-3 bg-purple-50 rounded-md">
                    <p className="text-sm text-purple-800">
                      Les animations permettent d'ajouter des spectacles, démonstrations ou activités 
                      spéciales à votre événement avec horaires et lieux dédiés.
                    </p>
                  </div>
                )}
              </div>
