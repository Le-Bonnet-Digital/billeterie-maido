/*
  ...
  1. Modifications
    - Ajouter la colonne `has_animations` à la table `events`
    - Créer la table `event_animations` si elle n'existe pas
    - Ajouter les policies de sécurité appropriées

  2. Sécurité
    - RLS activé sur `event_animations`
    - Policies pour admins et lecture publique
*/

-- Ajouter la colonne has_animations si elle n'existe pas
DO $$
BEGIN
  IF NOT EXISTS (
