/*
  # Système de billetterie événementielle complet
  ...
  3. Fonctionnalités
    ...
    - Réservation temporaire des créneaux (10 minutes)
    - Calculs automatiques des places restantes
...
CREATE POLICY "Users can view reservations by email" ON reservations
  FOR SELECT USING (true); -- Contrôlé au niveau application
...
CREATE POLICY "Anyone can manage their cart items" ON cart_items
  FOR ALL USING (true); -- Contrôlé au niveau application par session_id