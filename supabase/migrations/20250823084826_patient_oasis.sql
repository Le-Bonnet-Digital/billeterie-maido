/*
  ...
  2. Fonctions
    - Génération automatique de numéros de réservation
    - Calcul du stock restant pour les pass
    - Calcul de la capacité restante pour les créneaux
    - Nettoyage automatique des paniers expirés
    
  3. Sécurité
    - RLS activé sur toutes les tables
    - Politiques d'accès basées sur les rôles
    - Accès public pour les données publiées
    
  4. Données initiales
    - Événement "Les Défis Lontan" avec tous ses pass
    - Créneaux horaires pour poney et tir à l'arc
