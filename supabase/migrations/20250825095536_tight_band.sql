/*
  # Vérification et correction du schéma animations

  1. Vérification de la table event_animations
  2. Vérification de la colonne has_animations dans events
  3. Correction des policies si nécessaire
*/
