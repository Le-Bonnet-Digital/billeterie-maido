/*
  # Fonctions intelligentes de gestion des stocks

  1. Nouvelles fonctions
    - `get_pass_max_stock_from_activities` : calcule le stock maximum d'un pass basé sur ses activités
    - `get_pass_effective_remaining_stock` : calcule le stock effectif restant d'un pass
    - `update_pass_calculated_stock` : met à jour le stock calculé d'un pass
