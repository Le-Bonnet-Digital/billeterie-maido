...
-- Application de billetterie événementielle
...
DROP FUNCTION IF EXISTS get_pass_remaining_stock(uuid) CASCADE;
DROP FUNCTION IF EXISTS get_slot_remaining_capacity(uuid) CASCADE;
DROP FUNCTION IF EXISTS cleanup_expired_cart_items() CASCADE;
